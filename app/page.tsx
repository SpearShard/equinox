  ...
  return (
    <div className=" bg-white min-h-screen w-full overflow-x-hidden">
      ...
      <div className=" relative w-full h-[100vh] overflow-hidden">
        ...
        <h1 className=" leading-[1.2] max-sm:text-[5vw]  max-sm:w-[94vw] max-sm:top:10% text-[#3D2D72] text-[2vw] font-bold p-4">
      ...
      <div className="-mt-[10vw] relative z-2 px-[3vw]  max-sm:items-center max-sm:px-[0vw]">
        <div className="flex items-center max-sm:w-screen max-sm:flex-col max-sm:mt-[10vw]   gap-[5vw] justify-center">
          <div className="max-sm:w-[90vw]  max-sm:justify-center  w-57 p-4 h-70 bg-white flex flex-col shadow-lg rounded-lg flex items-center justify-center">
          ...
          <div className="max-sm:w-[90vw]  w-57 h-70 bg-white shadow-lg rounded-lg flex flex-col p-4 items-center justify-center">
      ...
      <div className="flex  max-sm:flex-col  pt-[3vw] gap-[2vw]">
      ...
      <div className="w-full px-[3vw] max-sm:px-[0vw] py-[4vw]">
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="mt-[2.5vw] flex justify-center">
            <Link href="/blogs" className="text-[1rem] bg-[#734EEC] text-white rounded-full px-6 py-2 hover:bg-[#5f3fe0] transition-colors">visit blogs page</Link>
          </div>
        </div>
      </div>
      ...
      <div className="w-full px-[3vw] py-[4vw]">
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="flex justify-center">
            <Link href="/faqs" className="text-[1rem] bg-[#734EEC] text-white rounded-full px-6 py-2 hover:bg-[#5f3fe0] transition-colors">Visit FAQs Page</Link>
          </div>
        </div>
      </div>
    </div>
