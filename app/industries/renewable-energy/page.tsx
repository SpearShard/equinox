...
export default function TransportationPage() {
  ...
  const content = {
    railways: {
      title: "Solar Energy",
      image: "https://Mechzilla Technologies.com/wp-content/uploads/2023/07/solarenergy-renewable.svg",
      Intitle:
      ...
      <div className="max-sm:overflow-x-hidden max-sm:relative min-h-screen bg-white">
        <div className="max-sm:flex max-sm:items-center  relative h-screen w-screen">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://Mechzilla Technologies.com/wp-content/uploads/2023/07/renewable.jpg')",
            }}
          ></div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-8 p-8">
          ...
          <div className=" flex-1">
            <video
              ...
              loop
            >
              <source src="https://Mechzilla Technologies.com/wp-content/uploads/2023/07/solar-inspection-video.mp4" type="video/mp4" />
