      ...
      <div className="min-h-screen bg-white">
        ...
        <div className=" bg-white max-sm:p-[0] max-sm:mx-[0] max-sm   px-12 py-16 max-w-[60vw] mx-auto">
          ...
          <div className="text-gray-700  max-sm:w-screen max-sm:p-[3vw] text-lg space-y-4 mb-8">
            <p>
              Mechzilla Technologies strive to provide clear-cut aerial drone surveying and mapping services across India. From serving the government and private sector in land surveying, aerial surveying for land management and development, land slope monitoring, stockpile volumetric measurements, designing smart cities, and mapping greenfield projects, our experience remains unsurpassed. Mechzilla Technologies prioritizes quality and consistently achieves highly accurate topographic maps with centimeter-level accuracy. Equipped with state-of-the-art surveying drones and a team of expert licensed pilots, our clients can access deliverables with greater speed, facilitating more nimble decision-making processes.
            </p>
            <p>
