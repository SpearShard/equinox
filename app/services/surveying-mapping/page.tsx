  ...
  return (
    <>
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-white px-12 py-16 max-w-[60vw] mx-auto">
          {/* Title */}
          <h1 className="text-[1.5vw] text-center font-bold text-[#3D2D72] mb-6">Drone Surveying / Mapping in India</h1>
          ...
          <h2 className="text-2xl font-semibold text-[#3D2D72] mb-4">Deliverables we provide:</h2>
        ...
        <div className="bg-white px-12 py-16 max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-[#3D2D72] mb-10 text-center">We can help with</h1>

          <div className="flex flex-col gap-6">

            {/* Tab 1 */}
            <div className="group flex items-center gap-6 p-4 border rounded-lg hover:shadow-lg transition-all duration-300">
              <div className="relative w-[20vw] h-[15vw] flex-shrink-0 transition-all duration-300 group-hover:w-[22vw]">
                <Image
        ...
        <div className="bg-white px-12 py-16 max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-[#3D2D72] mb-10 text-center">Deliverables we provide</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="group flex flex-col items-center text-center p-6 border rounded-lg hover:shadow-lg transition-all duration-300">
              ...
              <div className="relative w-[20vw] h-[15vw] mb-4 transition-transform duration-300 group-hover:scale-105">
                <Image
            ...
            <div className="group flex flex-col items-center text-center p-6 border rounded-lg hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">Drone images can also be used to create DSM models of the area. Each pixel contains 2D information (X, Y) and the altitude (Z value) of the highest point for this position.</p>
            </div>
            ...
            <div className="group flex flex-col items-center text-center p-6 border rounded-lg hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">Following the removal of objects like buildings, the drone images can be utilized to construct Digital Terrain Models (DTMs). In these models, each pixel stores 2.5D information, including the X, Y, and Z values corresponding to the highest altitude.</p>
            </div>
            ...
            <div className="group flex flex-col items-center text-center p-6 border rounded-lg hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">Depending on the project requirements, either the DTM or DSM model, with custom contour intervals, can be used to create a contour lines map, giving you a better understanding of the surface of the area shot by the drone.</p>
            </div>
            ...
            <div className="group flex flex-col items-center text-center p-6 border rounded-lg hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">The 3D textured mesh serves as a replica of the region captured by the drone, encompassing its edges, faces, vertices, and texture. This model proves particularly valuable for visual inspections or when project collaboration involves external stakeholders or public engagement.</p>
            </div>
        ...
        <div className="bg-white px-12 py-16 max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-[#3D2D72] mb-10 text-center">Our Features</h1>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">

            {/* Feature Tab 1 */}
            <div className="group flex flex-col border rounded-lg p-4 hover:shadow-lg transition-all duration-300">
        ...
        <div className="bg-white px-12 py-16 max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-[#3D2D72] mb-10 text-center">Industries We Serve</h1>
